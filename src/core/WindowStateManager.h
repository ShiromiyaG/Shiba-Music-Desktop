...
public:
    ...
    Q_INVOKABLE QVariantMap loadState(int defaultX, int defaultY, int defaultWidth, int defaultHeight,
                                      bool defaultMaximized = false, int minimumWidth = -1, int minimumHeight = -1) const;
